						...
						var theUI = {
							nodes : {
								...
								"GITHUB" : {
									color : "#007A73",
									alpha : 0,
									link : 'https://github.com/OkanKY'
								},
								"BLOG" : {
									color : "#004475",
									alpha : 0,
									link : 'http://okanky.blogspot.com.tr/'
								},							
								"LINKEDIN" : {
									color : "#002274",
									alpha : 0,
									link : 'https://www.linkedin.com/in/okanky'
								},
								"FACEBOOK" : {
									color : "#009A7B",
									alpha : 0,
									link : 'https://www.facebook.com/ok.ky.kaya'
								}
							},
							edges : {
								"OkanKY" : {
